...
from palsav_lite.archive import FArchiveReader, FArchiveWriter, coerce_bytes, uuid_reader, uuid_writer
from palsav_lite.rawdata.common import pal_item_and_num_read, pal_item_and_slot_writer, pal_item_booth_trade_info_read, pal_item_booth_trade_info_writer, pal_pal_booth_trade_info_read, pal_pal_booth_trade_info_writer
...
def encode_bytes(p: Optional[dict[str, Any]]) -> bytes:
    ...
    match map_object_concrete_model:
        ...
        case 'PalMapObjectItemBoothModel':
            ...
            writer.write(coerce_bytes(p['unknown_before_lock']))
    ...
    if 'trailing_unknown_bytes' in p:
